...
var TOPIC_ = [
  ...
  ['по животрепещущему вопросу', 'животрепещущего вопроса'], ['по животрепещущим вопросам', 'животрепещущих вопросов'],
  ['по современной проблематике', 'современной проблематики'], ['по современным проблематикам', 'современных проблематик'],
  ['по насущной предметной области', 'насущной предметной области'], ['по насущным предметным областям', 'насущных предметных областей'],
