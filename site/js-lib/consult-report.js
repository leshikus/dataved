var TRIPLES_ = [
  ...
  [
    ...
    'Анализ текущего статуса исполнения долгосрочной региональной целевой программы по внедрению и использованию инновационной информационной инфраструктуры',
	'Ключевые показатели эффективности использования инновационной информационной инфраструктуры'
  ],
  ...
  [
    ...
    'Снижение расходов на продвижение проектов Агентства',
    ...
    'Привлечение экспертов в области информационных технологий и телекоммуникаций к решению задач Агентства',
    ...
    'Привлечение инвесторов для финансирования проектов создания новых композиционных материалов в рамках инновационной площадки',
  ...
  [ 'Анализ и оптимизация организационной структуры', 
    ...
    'Методология и регламент сбора контактов и номеров телефонов заинтересованных лиц'
  ],
...
var TOPICS_ = [
  ...
  'Продвижение продукта #product для повышения эффективности проекта #project',
