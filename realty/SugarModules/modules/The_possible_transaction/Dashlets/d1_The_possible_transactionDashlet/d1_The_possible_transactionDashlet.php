...
require_once('modules/d1_The_possible_transaction/d1_The_possible_transaction.php');

class d1_The_possible_transactionDashlet extends DashletGeneric { 
    function d1_The_possible_transactionDashlet($id, $def = null) {
        ...
        if(empty($def['title'])) $this->title = translate('LBL_HOMEPAGE_TITLE', 'd1_The_possible_transaction');
